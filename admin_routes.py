...
def register_admin_routes(app):
    ...
    def admin_dashboard():
        ...
        # Get recent activities (placeholder - would need an Activity model for actual implementation)
        recent_activities = [
            {
                'icon': 'fas fa-user-plus',
                'time': 'اليوم 09:30',
                'description': 'تم إضافة 5 طلاب جدد'
            },
            {
                'icon': 'fas fa-book',
                'time': 'اليوم 10:15',
                'description': 'تم إضافة مادة دراسية جديدة: البرمجة المتقدمة'
            },
            {
                'icon': 'fas fa-tasks',
                'time': 'اليوم 11:30',
                'description': 'تم إضافة واجب جديد في مادة تطوير الويب'
            }
        ]
        
        # Get recent submissions
        recent_submissions = AssignmentSubmission.query.order_by(AssignmentSubmission.submitted_at.desc()).limit(5).all()
    ...
    def admin_add_assignment():
        ...
        if form.validate_on_submit():
            # Ensure Assignment model has creator_id field
    ...
    def admin_edit_assignment(assignment_id):
        ...
        return render_template('admin/assignment_form.html', form=form, assignment=assignment)
    ...
    def admin_edit_material(material_id):
        ...
        return render_template('admin/material_form.html', form=form, material=material)
